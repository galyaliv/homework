...
public class CalculatorWithCounterAutoSuper extends CalculatorWithMathExtends {
    ...
    public double multiply(double factor1, double factor2){
        counter++;
        return super.multiply(factor1, factor2);
    }
    ...
    public double subtract(double minuend, double subtrahend){
        counter++;
        return super.subtract(minuend, subtrahend);
    }
    ...
    public double pow(double indicator, int degree){
        ...
        counter++;
        return super.pow(indicator, degree);
    }
